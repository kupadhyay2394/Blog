...
const API_BASE_URL = 'https://your-api-backend.com'; 

// --- Post-Specific API Calls ---

export const getPostById = (postId) => {
  return api(`/api/posts/${postId}`, { baseUrl: API_BASE_URL });
};
...
export const togglePostLike = (postId, token) => {
  ...
  return api(`/api/posts/${postId}/like`, options, token);
};
...
export const deletePost = (postId, token) => {
  ...
  return api(`/api/posts/${postId}`, options, token);
};
